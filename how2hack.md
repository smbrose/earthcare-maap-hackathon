...
* For questions related to MAAP, use the `#maap-help` so mentors and organizers can assist you.

### Working with MAAP

* Large datasets and shared resources can be stored in the `eashrdata` so all participants can access them during the hackathon. If you **do not have access** to this folder, please notify the organizers as soon as possible so it can be resolved.
